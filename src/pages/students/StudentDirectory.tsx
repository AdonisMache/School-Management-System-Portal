...
export const StudentDirectory: React.FC = () => {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <div className="glass-panel p-6 rounded-2xl flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border border-[rgba(255,255,255,0.08)]">
        <div>
